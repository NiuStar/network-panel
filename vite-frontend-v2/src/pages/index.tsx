...
export default function IndexPage() {
          ...
          if (r && r.code === 0) {
            ...
            try {
              if (typeof r.data === "string")
                configCache.set("registration_enabled", r.data);
            } catch {}
          }
        }
  ...
  return (
    <DefaultLayout>
      <section className="flex flex-col items-center justify-start gap-6 py-6 sm:py-10 pb-20 min-h-[calc(100dvh-120px)] sm:min-h-[calc(100dvh-200px)]">
        <div className="w-full max-w-3xl px-4 sm:px-0">
          <Card className="np-card w-full">
            <CardHeader className="pb-2 pt-6 px-6">
              <h1 className="text-base font-semibold text-default-700">Login</h1>
            </CardHeader>
          ...
          {regEnabled && (
            <div className="mt-2">
              {!regMode ? (
                ...
                <div className="max-w-md mx-auto mt-2 p-3 np-soft">
                  <div className="grid gap-2">
                    ...
                    <Input
                      ...
                      variant="bordered"
                      onChange={(e) =>
                        setReg((prev) => ({ ...prev, confirm: e.target.value }))
                      }
                    />
