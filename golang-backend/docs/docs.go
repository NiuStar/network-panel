    ...
    "definitions": {
        ...
        "controller.SwaggerNodeCreateReq": {
            ...
            "properties": {
                ...
                "cycleMonths": {
                    "description": "New: prefer cycleMonths (1/3/6/12). cycleDays kept for backward-compat (30/90/180/365)",
                    "type": "integer"
                },
                "ip": {
                    "type": "string"
        ...
        "controller.SwaggerNodeInstallResp": {
            ...
            "properties": {
                "github": {
                    "type": "string",
                    "example": "curl -fsSL https://raw.githubusercontent.com/NiuStar/network-panel/refs/heads/main/install.sh -o install.sh \u0026\u0026 sudo bash install.sh -a 1.2.3.4:6365 -s secret"
                },
                "local": {
                    "type": "string",
                    "example": "curl -fsSL http://1.2.3.4:6365/install.sh -o install.sh \u0026\u0026 sudo bash install.sh -a 1.2.3.4:6365 -s secret"
                },
                "static": {
                    "type": "string",
                    "example": "curl -fsSL https://panel-static.199028.xyz/network-panel/install.sh -o install.sh \u0026\u0026 sudo bash install.sh -a 1.2.3.4:6365 -s secret"
                }
            }
        },
